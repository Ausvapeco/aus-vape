export const WHATSAPP_NUMBER = "+2349014313605";
export const WHATSAPP_URL = "https://wa.me/2349014313605";
...
export function WhatsAppFloatingButton() {
  return (
    <a
      href={whatsappLink("Hi AUSVAPE CO, I'd like some help with an order.")}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with AUSVAPE CO on WhatsApp"
      className="fixed bottom-5 right-5 z-40 h-14 w-14 rounded-full bg-[#25D366] text-[#0A0A0C] grid place-items-center shadow-[0_10px_30px_rgba(37,211,102,0.35)] hover:scale-105 transition-transform"
    >
